  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-6 h-[85vh] flex flex-col gap-6">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-6 min-h-0">
        {/* LiveKit Video Conference Panel */}
        <div className="lg:col-span-3 glass-card rounded-3xl glow overflow-hidden relative bg-slate-950/40">
          ...
          {livekitData ? (
            <LiveKitRoom
              token={livekitData.livekit_token}
              serverUrl={livekitData.livekit_url}
              connect={true}
              video={role === "INSTRUCTOR"}
              audio={role === "INSTRUCTOR"}
