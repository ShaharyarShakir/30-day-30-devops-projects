...
const (
	LiveSessionCreated    EventType = "live.session.created"
	LiveSessionStarted    EventType = "live.session.started"
	LiveSessionEnded      EventType = "live.session.ended"
	LiveParticipantJoined EventType = "live.participant.joined"
	LiveParticipantLeft   EventType = "live.participant.left"
)
